...
INSERT INTO lol_clay VALUES(null,"星之守护者套装","http://127.0.0.1:3000/img/show/show_1.jpg",255);
INSERT INTO lol_clay VALUES(null,"惊喜福袋礼包","http://127.0.0.1:3000/img/show/show_3.jpg",188);
#创建衣服列表
...
#创建用户详情列表
CREATE TABLE lol_userList(
	id INT,
	qq VARCHAR(20),
	reLoginId VARCHAR(255),
	birthday date,
